...
1.15.2 から 1.21.11 までの互換性を重視し、既存ユーザー体験を崩さない運用を目的としています。
...
コード互換目標: 1.15.2 - 1.21.11

## ステータス
- README 最終更新日: 2026-03-16
...
3. ログに `[Chairs] Enabling Chairs v1.1.0` が出ることを確認します。
...
## テスト
Paper 1.15.2 / 1.16.5 / 1.21.11 の実サーバーで手動確認済みです。
各環境で `Enabling Chairs` ログと正常起動を確認しています。
...
## 生成支援ツール利用
- 使用した AI: GPT-5.3-Codex
- 利用範囲: README 再構成・文言調整
